 ...
 */
public class DepositOrWithdrawl extends javax.swing.JFrame {

    public static String option;
    public static int checkIfItIsFirstRunVar;
    
    public DepositOrWithdrawl() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Make Transatcion - HPES");
        ...
        jLabel3.setText("Kindly, choose the preferred option");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepositOrWithdrawl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepositOrWithdrawl().setVisible(true);
            }
        });
    }
